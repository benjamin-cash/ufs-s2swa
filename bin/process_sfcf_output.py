...
def main():
    ...
    vlist = os.environ['SFCF_VARS'].split(" ")
    ...
    for count,netcdf_index in enumerate(netcdf_indices):
        for vname in vlist:
            ...
            subset_fname = os.path.join(os.environ['POSTDIR'],vname+".sfcf"+out_indices[count]+".nc")
            gmean_fname = os.path.join(os.environ['POSTDIR'],"gmean."+vname+".sfcf"+out_indices[count]+".nc")
